...
<body class="bg-[#F6F6F6]">
  ...
  <main>
      ...
      <div class="cs-banner-bg relative w-full bg-cover bg-center" style="background-image: url(public/images/pexels-asad-photo-maldives-3155666.jpg)">
        <div class="relative">
          <div class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] h-auto pt-[115px] pb-[62px] flex items-center">
            <div class="lg:w-1/2">
              <h1 class="font-['almarai'] font-extrabold text-[34px] sm:text-[44px] lg:text-[55px] xl:text-[64px] text-white mb-4">Accomodation</h1>
    ...
    <section>
      <div class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] pt-[55px] pb-[63px]">
        <article class="shadow-[0_4px_19px_-5px_rgba(0,0,0,0.25)]">
          <div class="mb-[30px] sm:mb-0 py-4 md:py-10 px-4 md:px-9 bg-white">
            <div class="mb-[34px] flex w-full justify-between">
              <div>
                <h1 class="font-['almarai'] font-bold text-xl lg:text-4xl text-[#1A7472]">Alaya Resort Bali</h1>
              </div>
              <div class="">
                <p class="font-['almarai'] font-bold text-xl lg:text-4xl text-[#53581E]">$160/night</p>
              </div>
            </div>
    ...
    <section>
      <div class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px]">
        <article class="shadow-[0_4px_19px_-5px_rgba(0,0,0,0.25)]">
          <div class="mb-[30px] sm:mb-0 py-4 md:py-10 px-4 md:px-9 bg-white">
            <div class="mb-[34px] flex w-full justify-between">
              <div>
                <h1 class="font-['almarai'] font-bold text-xl lg:text-4xl text-[#1A7472]">Amenities</h1>
              </div>
              <div class="">
                <p class="font-['almarai'] font-bold text-xl lg:text-4xl text-[#53581E]">$160/night</p>
              </div>
    ...
    <section class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] flex pt-[87px] pb-[63px]">
      ...
      <div class="sm:grid sm:grid-cols-3 sm:gap-[15px]">
        ...
        <article class="shadow-[0_4px_19px_-5px_rgba(0,0,0,0.25)]">
          <div class="bg-center bg-cover relative pt-[161px] lg:pt-[261px] 2xl:pt-[361px]" style="background-image: url('public/images/pexels-max-rahubovskiy-5997996.jpg')"></div>
          <div class="mb-[30px] sm:mb-0 py-4 md:py-5 px-4 md:px-6 bg-white">
            <div class="mb-3">
              <i class="fa-solid fa-star text-[#FFA500] text-1"></i>
              <i class="fa-solid fa-star text-[#FFA500] text-1"></i>
