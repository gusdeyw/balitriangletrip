      ...
      <div class="flex items-center">
        <div class="hidden lg:block">
          <ul class="flex">
            ...
            <li class="mr-2"><a href="accommodation.php" class="navbar-link font-['almarai'] underline-offset-4 md:text-lg xl:text-xl underline text-white">Accommodations</a></li>
  ...
  <div id="side-navbar-mob-content" class="h-full px-7 flex items-center">
    <div class="w-full text-center">
      <ul class="mb-9 text-center">
        ...
        <li class="mb-2"><a href="accommodation.php" class="text-[#9DA1A2] hover:text-[#1A7472] font-['almarai'] underline-offset-4 text-lg underline">Accommodations</a></li>
