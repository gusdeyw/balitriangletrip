<section>
  ...
  <div class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] flex justify-center mb-[54px]">
            ...
            <!-- <div class="grid grid-cols-2 sm:block"> -->
              <div>
                ...
                <ul>
                  ...
                  <li><a href="" class="text-sm lg:text-base text-white  tracking-wider font-['almarai']">Accomodation</a></li>
