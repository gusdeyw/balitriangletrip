...
<body class="bg-[#F6F6F6]">
  ...
  <main>
    <section>
      <div class="md:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] pt-[87px] pb-[103px]">
        <div class="mb-[65px] text-center">
          <p class="font-['allan'] md:text-3xl xl:text-4xl text-[#1A7472]">Explore</p>
          <h2 class="font-['almarai'] font-extrabold md:text-3xl xl:text-4xl text-[#1A7472] mb-[20px]">Our Services</h2>
          <p class="font-['almarai'] tracking-wider text-[#283325] md:text-lg xl:text-xl">Are your ready to embark on a journey filled with adventure, culture and relaxation?</p>
        </div>
