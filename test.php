    ...
    <div class="w-full h-screen bg-cover bg-center pt-52" style="background-image: url(public/images/comingsoonj.jpg);">
        <div class="px-[125px] grid grid-cols-2 items-center">
            ...
            <div class="flex justify-center ml-[130px]">
                <div class="h-[355px] w-[258px] bg-cover bg-center" style="background-image: url(public/images/pexels-oleksandr-p-2166559.jpg);">

                </div>
            </div>
        </div>
    </div>
    <div class="w-full h-screen bg-green-500"></div>
</body>
