...
<body class="bg-[#F6F6F6]">
  ...
  <main>
    <section>
      <div class="px-7 relative sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] pt-20 h-screen bg-cover bg-center flex items-center" style="background-image:url(public/images/comingsoon.jpg);">
        <div class="">
          <div class="sm:grid sm:grid-cols-3 sm:items-center">
            <div class="sm:col-span-2">
              <div class="sm:mr-6 lg:mr-[20%]">
    ...
    <section>
      <div class="sm:grid sm:grid-cols-2 px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] pt-[116px] pb-[114px]">
        <div class="block sm:hidden mb-6">
          <img src="public/images/pexels-oleksandr-p-2166608.jpg" alt="" class="h-[250px] w-full mb-4 object-cover">
          <img src="public/images/pexels-oleksandr-p-2100804.jpg" alt="" class="h-[250px] w-full object-cover">
        </div>
        <div>
          <p class="text-2xl sm:text-3xl xl:text-4xl text-[#1A7472] font-['allan']">The Ultimate Exprience</p>
    ...
    <section>
      <div class="px-7 sm:px-[50px] lg:px-[80px] xl:px-[125px] 2xl:px-[225px] pt-[22px] pb-[149px]">
        <div class="mb-[30px] text-center">
          <p class="font-['allan'] text-2xl sm:text-3xl xl:text-4xl text-[#1A7472]">Explore</p>
          <h2 class="font-['almarai'] font-extrabold text-2xl sm:text-3xl xl:text-4xl text-[#1A7472] mb-4">Our Services</h2>
          <p class="tracking-wider font-['almarai'] text-[#283325] xl:text-xl">Are your ready to embark on a journey filled with adventure, culture and relaxation?</p>
        </div>
        <div class="sm:grid sm:grid-cols-3 sm:gap-4">
          ...
          <div class="mb-4 sm:mb-0 bg-cover bg-center relative pt-[100%]" style="background-image:url(public/images/pexels-agus-nanda-15088860.jpg)">
            <div class="relative">
              <div class="bg-[#1A7472] h-[34px] flex items-center justify-center">
          ...
          <div class="mb-4 sm:mb-0 bg-cover bg-center relative pt-[100%]" style="background-image:url(public/images/pexels-arthouse-studio-4571926.jpg)">
            <div class="relative">
              <div class="bg-[#1A7472] h-[34px] flex items-center justify-center">
